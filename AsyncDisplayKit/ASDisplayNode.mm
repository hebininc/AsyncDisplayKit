...
- (ASLayout *)layoutThatFits:(ASSizeRange)constrainedSize parentSize:(CGSize)parentSize
{
  ...
  ASDisplayNodeAssertNotNil(pendingLayout->layout, @"nextLayout->layout should not be nil! %@", self);
  ...
  ASDisplayNodeAssertNotNil(pendingLayout->layout, @"-[ASDisplayNode layoutThatFits:parentSize:] pendingLayout->layout should not be nil! %@", self);
  return pendingLayout->layout ?: [ASLayout layoutWithLayoutElement:self size:{0, 0}];
}
